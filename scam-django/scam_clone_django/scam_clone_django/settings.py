"""
Django settings for scam_clone_django project.
...
ROOT_URLCONF = 'scam_clone_django.urls'
...
WSGI_APPLICATION = 'scam_clone_django.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'scam_clone_django/static'),
]
